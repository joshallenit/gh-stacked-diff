...
/*
Example output of PR list:
gh pr list --author "@me" --state "all" --json reviews --jq
{
  "reviews": [
    {
      "author": {
      ...
      "body": "",
      "commit": {
        "oid": "8d66f340d0e0f34329ff6f46d38a24c98eefdd0a"
      },
      "id": "PRR_kwDOImtARs6mnFOz",
      "includesCreatedEdit": false,
      "reactionGroups": [],
      "state": "APPROVED",
      "submittedAt": "2025-04-25T20:56:24Z"
    }
  ]
}
{
...
func getRecentReviewers() []string {
